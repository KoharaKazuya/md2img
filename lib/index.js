...
function md2img(path, callback) {
  ...
  marked(mdContents, {}, function(err, htmlContents) {
...
function html2image(path, html, callback) {
  puppeteer.launch().then(async browser => {
    ...
    const baseStyle = fs.readFileSync(__dirname + '/../assets/base.css', 'utf8');
    const github = fs.readFileSync(require.resolve('github-markdown-css'), 'utf8');
